...
*   📂 **`docs/URS_CIP_System.md`**: User Requirement Specification (URS) defining core process requirements and regulatory constraints.
*   📂 **`docs/FDS_CIP_System.md`**: Functional Design Specification (FDS) outlining thermal invalidation constraints and dynamic quality-driven boundary transitions.
*   📂 **`docs/OQ_Test_Protocol.md`**: Operational Qualification (OQ) test script outlining boundary test cases for system validation.
